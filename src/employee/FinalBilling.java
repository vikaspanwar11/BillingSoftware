...
public class FinalBilling extends javax.swing.JFrame {
    ...
    public FinalBilling(EmpDetails ed, String name, int total_bill, HashMap hm) {
        initComponents();
        
        this.ed=ed;
        jLabel2.setText(name);
        jLabel4.setText("Rs. "+String.valueOf(total_bill));
        
        GeneratePdf.generateBill(hm, name);
    }
    ...
    private void initComponents() {
        ...
        jButton1.setText("Finish Billing");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FinalBilling(null, null, 0, null).setVisible(true);
            }
        });
    }
